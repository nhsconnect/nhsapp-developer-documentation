...
This page is not intended to provide a comprehensive guide for NHS App web integrations. The information on these pages is a collation of guidance we have provided to integrating third party suppliers in response to developer issues or questions raised with the NHS App team. If the information you are looking for is not here, please contact [app.integration@nhs.net](mailto:app.integration@nhs.net).

## In this guide

* [Hiding Headers](/web-integration-guidance/#hideheaders)
* [Recognising Traffic](/web-integration-guidance/#recognisingtraffic)
* [Single Sign On](/web-integration-guidance/#sso)
* [Site Links](/web-integration-guidance/#sitelinks)
* [Limitations](/web-integration-guidance/#limitations)
